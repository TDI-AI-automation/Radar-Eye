...
| **Git commit used (validation session)** | `e06f160b60b119f39a4841b66adcdecabfa6b3f7` on `feature/RM-11-SIV-visualization` |
| **Baseline commit (evidence + review committed)** | `64baebb5381e17c0ea90ec5b0672e1aae46bb97a` on `feature/RM-11-SIV-visualization` |
| **Baseline tag** | `rm-11-development-siv-baseline` (annotated, points to the baseline commit above — `git show rm-11-development-siv-baseline`) |
...
- [`docs/ENGINEERING_GUIDELINES.md`](./ENGINEERING_GUIDELINES.md) — repository-wide policy, including the Permanent Engineering Evidence rule established from this session's `.gitignore` finding
