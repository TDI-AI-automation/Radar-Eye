"""Tests for shared.reconnect.

Promoted from apps/deepstream/tests/test_reconnect.py (Media
Architecture Reset, ADR-028) -- same coverage, new import path.
"""
...
from shared.reconnect import ReconnectPolicy, compute_backoff_seconds
...
class TestReconnectPolicy:
    ...
    def test_independent_instances_do_not_share_state(self) -> None:
        """One connection's failure/backoff state must never affect
        another's -- each caller owns its own ReconnectPolicy instance."""
